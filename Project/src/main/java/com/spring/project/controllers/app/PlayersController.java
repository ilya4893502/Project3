...
public class PlayersController {
    ...
    public String createPlayer(@ModelAttribute("player") PlayerDTO playerDTO,
            ...
            throws IOException {
        System.out.println(playerDTO.getFile().getOriginalFilename());
        playerDTO.setPlayerImage(playerDTO.getFile().getBytes());
        playersService.createPlayer(convertToPlayer(playerDTO), teamName);
    ...
    public String selectPlayer(@ModelAttribute("player") PlayerDTO playerDTO, Model model) {
    ...
    public String editPlayer(@PathVariable("player_name") String playerName,
                             ...
                             @RequestParam(value = "teamName", required = false) String teamName) {
        playersService.editPlayer(convertToPlayer(playerDTO), playerName, teamName);
        return "/account/admin/adminPage";
    }
